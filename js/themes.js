...
const WECHAT_THEMES = {
    ...
    keji: {
        ...
        h1: 'font-size:26px;font-weight:700;color:#14366b;margin:44px 0 22px;padding-bottom:14px;border-bottom:1px solid #d5dfe9;line-height:1.4;',
        h2: 'font-size:20px;font-weight:700;color:#14366b;margin:38px 0 16px;padding-left:12px;border-left:4px solid #14366b;line-height:1.45;',
        h3: 'font-size:16.5px;font-weight:600;color:#14366b;margin:26px 0 12px;',
        p: 'margin:18px 0;text-align:justify;text-justify:inter-ideograph;',
        strong: 'font-weight:700;color:#14366b;',
        ...
        th: 'color:#14366b;font-weight:700;padding:12px 16px;text-align:left;border-bottom:2px solid #14366b;',
    ...
    jinshe: {
        ...
        strong: 'font-weight:700;color:#8a6d3b;',
        ...
        th: 'color:#8a6d3b;font-weight:600;padding:13px 16px;text-align:left;border-bottom:1px solid #a78b57;letter-spacing:1px;',
    ...
    nuanyang: {
        ...
        h1: 'font-size:26px;font-weight:800;color:#d4540a;margin:44px 0 22px;line-height:1.4;',
        h2: 'font-size:20px;font-weight:700;color:#d4540a;margin:36px 0 16px;padding-bottom:8px;border-bottom:2px solid #f0c9a8;line-height:1.45;',
        h3: 'font-size:16.5px;font-weight:700;color:#d4540a;margin:26px 0 12px;',
        p: 'margin:18px 0;',
        strong: 'font-weight:700;color:#d4540a;',
        ...
        li: 'margin:10px 0;',
        table: 'width:100%;border-collapse:collapse;margin:28px 0;font-size:14px;',
        th: 'color:#d4540a;font-weight:700;padding:12px 16px;text-align:left;border-bottom:2px solid #e8813a;',
    ...
    zijie: {
        ...
        p: 'margin:16px 0;',
        strong: 'font-weight:600;color:#1456f0;',
    ...
    saibo: {
        ...
        h1: 'font-size:26px;font-weight:800;color:#4c1d95;margin:44px 0 22px;padding-bottom:14px;border-bottom:2px solid #4c1d95;line-height:1.4;letter-spacing:1px;',
        h2: 'font-size:20px;font-weight:700;color:#4c1d95;margin:38px 0 16px;padding-bottom:6px;border-bottom:2px solid #22d3ee;display:inline-block;letter-spacing:1px;line-height:1.45;',
        h3: 'font-size:16.5px;font-weight:700;color:#6d28d9;margin:26px 0 12px;letter-spacing:0.5px;',
        p: 'margin:18px 0;',
        strong: 'font-weight:700;color:#6d28d9;',
        ...
        li: 'margin:10px 0;',
        table: 'width:100%;border-collapse:collapse;margin:28px 0;font-size:14px;',
        th: 'color:#4c1d95;font-weight:700;padding:12px 16px;text-align:left;border-bottom:2px solid #7c3aed;',
    ...
    shuzhai: {
        ...
        strong: 'font-weight:700;color:#8a5a2b;',
    ...
    baogao: {
        ...
        h2: 'font-size:20px;font-weight:700;color:#123a63;margin:38px 0 16px;padding-bottom:8px;border-bottom:2px solid #123a63;',
        h3: 'font-size:16px;font-weight:600;color:#34558a;margin:26px 0 12px;',
